...
/* Hide default GitHub source button */
[data-testid="stToolbar"] { display: none !important; }
a[href*="github.com"][title],
.stActionButton { display: none !important; }

/* Custom GitHub button (top-right) */
.gh-btn {
...
.gh-btn:hover { background: #30363d; border-color: #8b949e; color: #fff; }
...
st.markdown("""
<a class="gh-btn" href="https://github.com/shrek6201" target="_blank">
